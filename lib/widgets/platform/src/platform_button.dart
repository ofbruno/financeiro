...
import 'package:flutter/material.dart' show MaterialButton, FlatButton, RaisedButton, Brightness, ButtonTextTheme, MaterialTapTargetSize;
...
class PlatformButton extends PlatformWidgetBase<CupertinoButton, MaterialButton> {
  ...
  MaterialButton createAndroidWidget(BuildContext context) {
    ...
    return RaisedButton(
      ...
      elevation: dataRaised?.elevation ?? elevation,
      ...
      shape: dataRaised?.shape ?? shapeBorder,
      ...
      focusNode: dataRaised?.focusNode ?? focusNode,
