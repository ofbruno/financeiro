  ...
  Widget build(BuildContext context) {
    ...
    return new Container(
      child: TextFormField(
        ...
        style: TextStyle(
          fontSize: Responsivo.fonte(this.fontSizeResponsive),
          color: (this.enabled && !this.readOnly) || (this.readOnly && this.keepColorActiveWhenReadOnly) ? Colors.black : Color.fromRGBO(153, 153, 153, 1),
        ),
